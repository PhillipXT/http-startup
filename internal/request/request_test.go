...
// Read reads up to len(p) or numBytesPerRead bytes from the string per call, for
// simulating reading a variable number of bytes per chunk from a network connection
...
func TestRequestLineParse(t *testing.T) {
	...
	// Test: Bad method format in Request line
	r, err = RequestFromReader(strings.NewReader("Get /coffee HTTP/1.2\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n"))
	require.Error(t, err)

}

func TestHeadingParse(t *testing.T) {
